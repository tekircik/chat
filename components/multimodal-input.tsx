    ...
    <div className="relative w-full flex flex-col gap-4">
      ...
      <div className="absolute bottom-0 p-2 w-fit flex flex-row justify-start gap-2">
        ...
        <Button
          ...
          variant="ghost"
          className={cx(
            "rounded-md p-[7px] h-fit flex items-center",
            {
              "bg-blue-100/50 dark:bg-blue-900/20": isReasoning
            }
          )}
          aria-pressed={isReasoning}
          title="Toggle Reasoning Mode"
          onClick={handleReasoningToggle}
          data-active={isReasoning}
        >
          <div className={cx({ 'text-blue-500 dark:text-blue-400': isReasoning })}>
            <SparklesIcon size={16} />
          </div>
          <span
            className={cx(
              'ml-1 text-xs font-medium hidden md:inline',
              { 'text-blue-500 dark:text-blue-400': isReasoning },
            )}
          >
            Reasoning
          </span>
